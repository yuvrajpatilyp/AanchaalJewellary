    ...
    <div className="group cursor-pointer">
      <div className="relative bg-white  overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
        ...
        <div className="relative w-full h-80 overflow-hidden">
         ...
         {Bestseller && (
            <span
            className="absolute top-2 left-1.5 bg-pink-600 text-white text-1xl
      ...
      <div className="px-4 py-3">
        ...
        <button
          ...
          className="mt-3 w-full bg-linear-to-r from-pink-300 via-pink-500 to-pink-700 text-white py-2 rounded-md font-semibold transition-all
