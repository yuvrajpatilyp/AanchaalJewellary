...
function NavigationBar() {
  return (
    <nav className="flex flex-wrap justify-between items-center px-6 md:px-10 py-4 border-b border-gray-200">
      ...
      <div className="flex gap-4 md:gap-8 text-xs md:text-sm tracking-wide font-medium text-gray-700 w-full md:w-auto justify-center md:justify-start py-2 md:py-0">
