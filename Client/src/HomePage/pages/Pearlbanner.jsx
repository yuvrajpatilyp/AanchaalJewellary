...
function PearlPage() {
  ...
  const productsData = [
     ...
     newprice:"2,699",
     oldprice:"5,999",
     image:"src/assets/Pearl/pearl1.webp",
     hoverImage:"src/assets/Pearl/pearl1hover.webp",
    ...
    },
    {
     ...
     newprice:"4,699",
     oldprice:"5,999",
     image:"src/assets/Pearl/pearl11.webp",
     hoverImage:"src/assets/Pearl/pearl11hover.webp",
      Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
    {
     ...
     newprice:"6,699",
     oldprice:"7,999",
     image:"src/assets/Pearl/pearl10.webp",
     hoverImage:"src/assets/Pearl/pearl10hover.webp",
      Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
    {
     ...
     newprice:"2,699",
     oldprice:"5,999",
     image:"src/assets/Pearl/pearl9.webp",
     hoverImage:"src/assets/Pearl/pearl9hover.webp",
      Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
     {
     ...
     newprice:"6,699",
     oldprice:"7,999",
     image:"src/assets/Pearl/pearl8.webp",
     hoverImage:"src/assets/Pearl/pearl8hover.webp",
      Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
    {
     ...
     newprice:"3,699",
     oldprice:"5,999",
     image:"src/assets/Pearl/pearl7.webp",
     hoverImage:"src/assets/Pearl/pearl7hover.webp",
    ...
    },
    {
     ...
     newprice:"3,699",
     oldprice:"5,999",
     image:"src/assets/Pearl/pearl6.webp",
     hoverImage:"src/assets/Pearl/pearl6hover.webp",
     Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
    {
     ...
     newprice:"6,699",
     oldprice:"7,999",
     image:"src/assets/Pearl/pearl4.webp",
     hoverImage:"src/assets/Pearl/pearl4hover.webp",
    ...
    },
    {
     ...
     newprice:"6,699",
     oldprice:"7,999",
     image:"src/assets/Pearl/pearl3.webp",
     hoverImage:"src/assets/Pearl/pearl3hover.webp",
      Bestseller:"bestseller",
     onAddToCart: handleAddToCart,
    },
    {
     ...
     newprice:"6,699",
     oldprice:"7,999",
     image:"src/assets/Pearl/pearl2.jpg",
     hoverImage:"src/assets/Pearl/pearl2hover.webp",
  ...
  return (
    <div   className="w-full">
      <div  onClick={handleScrollToProducts} className="relative w-full h-[260px] sm:h-[350px] md:h-[450px] lg:h-[520px] overflow-hidden shadow-xl cursor-pointer">
        <img
          src="src\assets\BannerImg\slide-img6.jpg"
