    ...
    <div className='flex  gap-5 max-w-5xl mx-auto px-4 py-9  '> 
           <Link to='/casual'> 
            ...
            <img src='/src/assets/casuale.jpg ' 
                 className=' rounded-xl border-4 border-[#eab676] shadow-xl h-[400px] w-[400px] transition delay-150 duration-400 ease-in hover:-translate-y-1 hover:scale-110'></img>
